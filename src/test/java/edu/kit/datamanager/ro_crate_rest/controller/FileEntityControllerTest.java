...
public class FileEntityControllerTest {
  ...
  public void testAddEntity() throws Exception {
    ...
    this.mockMvc
        .perform(put("/crates/" + crateId + "/entities/data/files/" + fileIdEncoded)
            .content(
  ...
  public void testDeleteEntity() throws Exception {
    ...
    this.mockMvc
        .perform(delete("/crates/" + crateId + "/entities/data/files/" + encodedFileId)
            .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().is(HttpStatus.NO_CONTENT.value()));
  ...
  public void testGetEntity() throws Exception {
    ...
    MvcResult res = this.mockMvc
        .perform(get("/crates/" + crateId + "/entities/data/files/" + encodedFileId))
  ...
  public void testAddEntityProperty() throws Exception {
    ...
    this.mockMvc
        .perform(put(
            "/crates/" + crateId + "/entities/data/files/" + encodedFileId + "/name")
